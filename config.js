...
global.stickpack = '𝗘𝗹𝗮𝗶𝗻𝗮-𝘉𝘰𝘵𝘻' //ganti 
global.stickauth = `© 𝗘𝗹𝗮𝗶𝗻𝗮-𝘉𝘰𝘵𝘻` //gantii 
global.week = `${week} ${date}` //Gak usah
global.wibb = `${wktuwib}` // Gak usah 
//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ OWNER INFO ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
global.nameown1= '𝘞𝘢𝘩𝘢𝘣 𝘈𝘵𝘢𝘳𝘪𝘢𝘯𝘶𝘴' //ganti 
global.nameown2 = '𝘐𝘯𝘰𝘳𝘺 𝘗𝘶𝘵𝘳𝘪' //ganti 
//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ MEDIA LINK ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
global.Linkgc = '𝘛𝘶𝘯𝘨𝘨𝘶 𝘚𝘦𝘣𝘦𝘯𝘵𝘢𝘳 𝘖𝘯𝘪𝘤𝘩𝘢𝘯🥰...'
...
global.gcwangsaf = 'https://chat.whatsapp.com/IGVfMjqdUtpBn2bnmttFDb' //Group wa juga 
global.fakeyt = '-' //Yt jika punya
global.sdc = '-' //discord klo ga punya ga usah biarin aja
global.sfb = 'https://www.facebook.com/profile.php?id=100083728134253' // facebook
...
global.psaweria = 'https://telegra.ph/file/602e83b680456e0095649.jpg' //Ganti aja ini Link gambar QR

//bebas cuyyy yg atas mahh 

//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ TAMPILAN ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
global.ListHargaSewa = '├ 7 Hari IDR 8.000\n├ 20 Hari IDR 25.000\n├ 30 Hari IDR 35.000\n├ PERMANEN IDR 15.000'
//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ TAMPILAN ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
global.LyAtas1 = '☰ ━━━ ❨'
global.LyAtas2 = '❩ ━━┄┈ •⟅'
global.Ly = '┃'
...
global.wait = '▰▰▰▰▰▰▱▱ 98% 𝚠𝚊𝚒𝚝!!'
global.eror = '𝘔𝘰𝘩𝘰𝘯 𝘔𝘢𝘢𝘧 𝘚𝘦𝘳𝘷𝘦𝘳 𝘒𝘢𝘮𝘪 𝘚𝘦𝘥𝘢𝘯𝘨 𝘌𝘳𝘰𝘳!'
global.md = '_𝘐𝘯 𝘱𝘳𝘰𝘨𝘳𝘦𝘴𝘴, 𝘱𝘭𝘦𝘢𝘴𝘦 𝘸𝘢𝘪𝘵..._'
...
global.syt = 'https://chat.whatsapp.com/IGVfMjqdUtpBn2bnmttFDb' //youtube
global.sytv = 'https://chat.whatsapp.com/IGVfMjqdUtpBn2bnmttFDb'//link video yt
global.packname = wm
...
global.ultahowner = 'Juni 26 2006' //ultah luh 😭
...
global.fpagedoc = '999'
global.thumbdoc = 'https://telegra.ph/file/170bdb7fe31ca65beeeaf.jpg'
